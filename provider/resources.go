...
import (
	...
	"github.com/koyeb/terraform-provider-koyeb/koyeb" // Import the upstream provider
	...
	"github.com/koyeb/pulumi-koyeb/provider/pkg/version"
)
...
const (
	...
	mainPkg = "koyeb"
	// modules:
	mainMod = "index" // the koyeb module
)

//go:embed cmd/pulumi-resource-koyeb/bridge-metadata.json
var metadata []byte
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		//
		//    - In provider/cmd/pulumi-tfgen-koyeb/main.go, replace the
		...
		//
		//    - In provider/cmd/pulumi-resource-koyeb/main.go, replace the
		...
		//
		//      	tfbridge.Main(context.Background(), "koyeb", koyeb.Provider(),
		...
		// convention is to have a function at "github.com/iwahbe/terraform-provider-koyeb/provider".New
		...
		//
		//nolint:lll
		P: shimv2.NewProvider(koyeb.New(version.Version)()),
		...
		Keywords:   []string{"koyeb", "category/cloud"},
		License:    "Apache-2.0",
		...
		Golang: &tfbridge.GolangInfo{
			...
			ImportBasePath: path.Join(
				"github.com/koyeb/pulumi-koyeb/sdk/",
	...
	prov.MustComputeTokens(tokens.SingleModule("koyeb_", mainMod,
