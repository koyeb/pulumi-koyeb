...
export interface GetServiceDefinition {
    docker?: outputs.GetServiceDefinitionDocker;
    envs?: outputs.GetServiceDefinitionEnv[];
    git?: outputs.GetServiceDefinitionGit;
    healthChecks?: outputs.GetServiceDefinitionHealthCheck[];
    instanceTypes: outputs.GetServiceDefinitionInstanceType[];
    /**
     * The service name
     */
    name: string;
    ports?: outputs.GetServiceDefinitionPort[];
    /**
     * The service deployment regions to deploy to
     */
    regions: string[];
    routes?: outputs.GetServiceDefinitionRoute[];
    scalings: outputs.GetServiceDefinitionScaling[];
    /**
     ...
     */
    volumes?: outputs.GetServiceDefinitionVolume[];
}

export interface GetServiceDefinitionDocker {
    /**
...
export interface GetServiceDefinitionEnv {
    /**
...
export interface GetServiceDefinitionGit {
    /**
     * The GitHub branch to deploy
     */
    branch: string;
    buildpack?: outputs.GetServiceDefinitionGitBuildpack;
    dockerfile?: outputs.GetServiceDefinitionGitDockerfile;
    /**
...
export interface GetServiceDefinitionGitBuildpack {
    /**
...
export interface GetServiceDefinitionGitDockerfile {
    /**
...
export interface GetServiceDefinitionHealthCheck {
    /**
     * The period in seconds to wait for the instance to become healthy, default is 5s
     */
    gracePeriod?: number;
    http?: outputs.GetServiceDefinitionHealthCheckHttp;
    /**
     ...
     */
    restartLimit?: number;
    tcp?: outputs.GetServiceDefinitionHealthCheckTcp;
    /**
...
export interface GetServiceDefinitionHealthCheckHttp {
    headers?: outputs.GetServiceDefinitionHealthCheckHttpHeader[];
    /**
...
export interface GetServiceDefinitionHealthCheckHttpHeader {
    /**
...
export interface GetServiceDefinitionHealthCheckTcp {
    /**
     * The port to use to perform the health check
     */
    port: number;
...
export interface GetServiceDefinitionInstanceType {
    /**
...
export interface GetServiceDefinitionPort {
    /**
...
export interface GetServiceDefinitionRoute {
    /**
...
export interface GetServiceDefinitionScaling {
    /**
     ...
     */
    scopes: string[];
    targets?: outputs.GetServiceDefinitionScalingTarget[];
}

export interface GetServiceDefinitionScalingTarget {
    /**
     * The CPU usage (expressed as a percentage) across all Instances of your Service within a region
     */
    averageCpus?: outputs.GetServiceDefinitionScalingTargetAverageCpus[];
    /**
     * The memory usage (expressed as a percentage) across all Instances of your Service within a region
     */
    averageMems?: outputs.GetServiceDefinitionScalingTargetAverageMem[];
    /**
     * The number of concurrent requests across all Instances of your Service within a region
     */
    concurrentRequests?: outputs.GetServiceDefinitionScalingTargetConcurrentRequest[];
    /**
     * The average response time of requests across all Instances of your Service within a region
     */
    requestResponseTimes?: outputs.GetServiceDefinitionScalingTargetRequestResponseTime[];
    /**
     * The number of concurrent requests per second across all Instances of your Service within a region
     */
    requestsPerSeconds?: outputs.GetServiceDefinitionScalingTargetRequestsPerSecond[];
}

export interface GetServiceDefinitionScalingTargetAverageCpus {
    /**
...
export interface GetServiceDefinitionScalingTargetAverageMem {
    /**
     * The target value of the autoscaling target
     */
    value: number;
...
export interface GetServiceDefinitionScalingTargetConcurrentRequest {
    /**
     * The target value of the autoscaling target
     */
    value: number;
...
export interface GetServiceDefinitionScalingTargetRequestResponseTime {
    /**
     * The target value of the autoscaling target
     */
    value: number;
...
export interface GetServiceDefinitionScalingTargetRequestsPerSecond {
    /**
     * The target value of the autoscaling target
     */
    value: number;
...
export interface GetServiceDefinitionVolume {
    /**
...
export interface ServiceDefinitionScalingTarget {
     ...
     * The number of concurrent requests across all Instances of your Service within a region
     */
    concurrentRequests?: outputs.ServiceDefinitionScalingTargetConcurrentRequest[];
    /**
     * The average response time of requests across all Instances of your Service within a region
     */
    requestResponseTimes?: outputs.ServiceDefinitionScalingTargetRequestResponseTime[];
    /**
     * The number of concurrent requests per second across all Instances of your Service within a region
     */
