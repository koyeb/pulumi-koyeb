...
namespace Pulumi.Koyeb
{
    ...
    /// ```
    /// </summary>
    [KoyebResourceType("koyeb:index/domain:Domain")]
    public partial class Domain : global::Pulumi.CustomResource
    {
        ...
        public Domain(string name, DomainArgs? args = null, CustomResourceOptions? options = null)
            : base("koyeb:index/domain:Domain", name, args ?? new DomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Domain(string name, Input<string> id, DomainState? state = null, CustomResourceOptions? options = null)
            : base("koyeb:index/domain:Domain", name, state, MakeResourceOptions(options, id))
        {
        }
